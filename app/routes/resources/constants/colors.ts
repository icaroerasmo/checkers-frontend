export const BLACK_TILE_COLOR = 'rgb(34, 34, 34)'
export const WHITE_TILE_COLOR = 'rgb(237, 238, 233)'
export const PIECE_FROM_COLOR = 'rgba(0, 71, 171, 0.6)'
export const POSSIBLE_MOVE_COLOR = 'rgba(240, 230, 140, 0.6)'
